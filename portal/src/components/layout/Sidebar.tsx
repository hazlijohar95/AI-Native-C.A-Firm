...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed inset-0 z-[9998] bg-black/60 lg:hidden animate-in fade-in duration-200"
          onClick={onClose}
          aria-hidden="true"
        />
      )}
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-[9999] w-64 bg-gradient-to-b from-white to-[#FAF8F5] border-r border-[rgba(184,152,107,0.1)] shadow-2xl lg:hidden transition-transform duration-300 ease-in-out",
